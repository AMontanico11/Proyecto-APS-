  ...
  let Despliegue = [
      {
          ...
          '<div class="table">'+
              '<div class="Sección1">'+
                 ...
                 '<div><img class="fon-inferior" src="https://github.com/Gerardo072/Tablas-ApS-img/blob/main/Aceites.png?raw=true" alt=""></div>'+
                 '<div><img class="fon-inferior" src="https://github.com/Gerardo072/Tablas-ApS-img/blob/main/Arroz.png?raw=true alt=""></div>'+
                 '<div><img class="fon-inferior" src="https://github.com/Gerardo072/Tablas-ApS-img/blob/main/Aves.png?raw=true" alt=""></div>'+
                 '<div><img class="fon-inferior" src="https://github.com/Gerardo072/Tablas-ApS-img/blob/main/Az%C3%BAcar%20y%20productos%20dulces.png?raw=true" alt=""></div>'+
                 '<div><img class="fon-inferior" src="https://github.com/Gerardo072/Tablas-ApS-img/blob/main/Bebidas.png?raw=true" alt=""></div>'+
                 '<div><img class="fon-inferior" src="https://github.com/Gerardo072/Tablas-ApS-img/blob/main/Carne%20de%20cerdo.png?raw=true" alt=""></div>'+
                 '<div><img class="fon-inferior" src="https://github.com/Gerardo072/Tablas-ApS-img/blob/main/Carne%20de%20pollo.png?raw=true" alt=""></div>'+
                 '<div><img class="fon-inferior" src="https://github.com/Gerardo072/Tablas-ApS-img/blob/main/Carne%20de%20vaca.png?raw=true" alt=""></div>'+
                 '<div><img class="fon-inferior" src="https://github.com/Gerardo072/Tablas-ApS-img/blob/main/Carne.png?raw=true" alt=""></div>'+
                 '<div><img class="fon-inferior" src="https://github.com/Gerardo072/Tablas-ApS-img/blob/main/Cereales%20y%20salvados.png?raw=true" alt=""></div>'+
                 '<div><img class="fon-inferior" src="https://github.com/Gerardo072/Tablas-ApS-img/blob/main/Copos%20y%20papilla%20de%20cereales.png?raw=true" alt=""></div>'+
                 '<div><img class="fon-inferior" src="https://github.com/Gerardo072/Tablas-ApS-img/blob/main/Embutidos.png?raw=true" alt=""></div>'+
                 '<div><img class="fon-inferior" src="https://github.com/Gerardo072/Tablas-ApS-img/blob/main/Frutas%20deshidratadas.png?raw=true" alt=""></div>'+
                 '<div><img class="fon-inferior" src="https://github.com/Gerardo072/Tablas-ApS-img/blob/main/Frutas.png?raw=true" alt=""></div>'+
                 '<div><img class="fon-inferior" src="https://github.com/Gerardo072/Tablas-ApS-img/blob/main/Frutos%20secos.png?raw=true" alt=""></div>'+
                 '<div><img class="fon-inferior" src="https://github.com/Gerardo072/Tablas-ApS-img/blob/main/Harinas.png?raw=true" alt=""></div>'+
                 '<div><img class="fon-inferior" src="https://github.com/Gerardo072/Tablas-ApS-img/blob/main/Hortalizas.png?raw=true" alt=""></div>'+
                 '<div><img class="fon-inferior" src="https://github.com/Gerardo072/Tablas-ApS-img/blob/main/Huevos.png?raw=true" alt=""></div>'+
                 '<div><img class="fon-inferior" src="https://github.com/Gerardo072/Tablas-ApS-img/blob/main/Lacteos.png?raw=true" alt=""></div>'+
                 '<div><img class="fon-inferior" src="https://github.com/Gerardo072/Tablas-ApS-img/blob/main/Legumbres.png?raw=true" alt=""></div>'+
                 '<div><img class="fon-inferior" src="https://github.com/Gerardo072/Tablas-ApS-img/blob/main/Mantequillas,%20margarinas%20y%20otras%20grasas.png?raw=true" alt=""></div>'+
                 '<div><img class="fon-inferior" src="https://github.com/Gerardo072/Tablas-ApS-img/blob/main/Moluscos%20y%20crust%C3%A1seos.png?raw=true" alt=""></div>'+
                 '<div><img class="fon-inferior" src="https://github.com/Gerardo072/Tablas-ApS-img/blob/main/Pan.png?raw=true" alt=""></div>'+
                 '<div><img class="fon-inferior" src="https://github.com/Gerardo072/Tablas-ApS-img/blob/main/Pasta%20y%20masas.png?raw=true" alt=""></div>'+
                 '<div><img class="fon-inferior" src="https://github.com/Gerardo072/Tablas-ApS-img/blob/main/Pescados.png?raw=true" alt=""></div>'+
                 '<div><img class="fon-inferior" src="https://github.com/Gerardo072/Tablas-ApS-img/blob/main/Productos%20lacteos.png?raw=true" alt=""></div>'+
                 '<div><img class="fon-inferior" src="https://github.com/Gerardo072/Tablas-ApS-img/blob/main/Setas.png?raw=true" alt=""></div>'+
                 '<div><img class="fon-inferior" src="https://github.com/Gerardo072/Tablas-ApS-img/blob/main/Sustitutos%20de%20lacteos.png?raw=true" alt=""></div>'+
...
document.addEventListener("keyup", e=>{
  if(e.target.matches("#searchbar")){
      document.querySelectorAll(".animals").forEach(articulo => {
